...
import { ArrowLeft, ExternalLink, AlertCircle, MessageSquare, Calendar, Tag } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
        {isLoading ? (
          ...
          <div className="space-y-4">
            ...
            {issues.map((issue) => (
              <div key={issue.id} className="card-interactive p-5 hover:shadow-md transition-shadow">
